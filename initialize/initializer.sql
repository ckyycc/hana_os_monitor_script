--CREATE TABLE
DROP TABLE "HANA_OS_MONITOR"."M_INSTANCE_INFO";
CREATE COLUMN TABLE "HANA_OS_MONITOR"."M_INSTANCE_INFO" ("CHECK_ID" VARCHAR(20) NOT NULL,
...
DROP VIEW "HANA_OS_MONITOR"."M_CURRENT_INSTANCE_INFO";
CREATE VIEW "HANA_OS_MONITOR"."M_CURRENT_INSTANCE_INFO" ( "SERVER_ID",
	 "SERVER_NAME",
	 "SERVER_FULL_NAME",
	 "SID",
	 "INSTANCE_NUM",
	 ...
	 A.CHECK_TIME,
	 A.CHECK_ID
FROM HANA_OS_MONITOR.M_INSTANCE_INFO A
INNER JOIN HANA_OS_MONITOR.SERVER_INFO B ON A.SERVER_ID = B.SERVER_ID
INNER JOIN (SELECT
	 MAX(CHECK_ID) CHECK_ID,
	 SERVER_ID
	from HANA_OS_MONITOR.M_INSTANCE_INFO
...
DROP VIEW "HANA_OS_MONITOR"."M_ALL_INSTANCE_DETAIL_INFO";
CREATE VIEW "HANA_OS_MONITOR"."M_ALL_INSTANCE_DETAIL_INFO" ( "SERVER_ID",
	 "SERVER_NAME",
	 "SID",
	 "INSTANCE_NUM",
	 "HOST",
	 ...
	 A.CHECK_TIME,
	 A.CHECK_ID
FROM HANA_OS_MONITOR.M_CURRENT_INSTANCE_INFO A
LEFT JOIN (SELECT
	 SERVER_ID,
